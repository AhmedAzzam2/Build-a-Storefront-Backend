...
exports.delproduct = exports.update = exports.create = exports.show = exports.index = void 0;
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, onen.create(productNew)];
            case 1:
                newproduct = _a.sent();
                res.json(newproduct);
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                // check req.body before send to database 
                console.log(req.body);
                return [4 /*yield*/, onen.updateproduct(productNew)];
            case 1:
                newproduct = _a.sent();
                res.json(newproduct);
                // check newproduct after send to database 
